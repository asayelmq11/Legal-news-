...
databases. Applies every migration twice, then loads dev fixtures and runs 78 assertions plus a TypeScript/SQL normalisation parity check.
...
78 assertions, all passing against Postgres 16.13:
