...
| `npm run test` | vitest — 131 assertions across auth, guards, Arabic search, filters, links, dashboard |
...
supabase/
  ...
  tests/              SQL verification suite (78 assertions)
...
| M7 Admin: sources / users / settings | ⬜ next |
